...
public abstract class Piece {
    ...
    public boolean equals(Object obj) {
        ...
        else if(this.kills != temp.kills) return false;
        else if(this.alive != temp.alive) return false;
        else if(this.firstMove != temp.firstMove) return false;
        else if(this.alliance != temp.alliance) return false;
        else if(this.index != temp.index) return false;
        else if(this.type != temp.type) return false;
        else return true;
    }
}
